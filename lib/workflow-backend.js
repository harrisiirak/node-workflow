...
//        job properties
// callback - f(err, job)
WorkflowBackend.prototype.getJobByTarget = function (job, meta, callback) {
    throw new Error('Backend.getJobByTarget is not implemented');
};
...
WorkflowBackend.prototype.createSchedule = function (schedule, meta, callback) {
    throw new Error('Backend.createSchedule is not implemented');
};

// schedule - Schedule object. Schedule.uuid property used to verify record
//            exists
// meta - Any additional information to pass to the backend which is not
//        schedule properties
// callback - f(err, schedule)
WorkflowBackend.prototype.updateSchedule = function (schedule, meta, callback) {
    throw new Error('Backend.updateSchedule is not implemented');
};
...
//        schedule properties
// callback - f(err, boolean)
WorkflowBackend.prototype.deleteSchedule = function (schedule, meta, callback) {
    throw new Error('Backend.deleteSchedule is not implemented');
};
...
//        schedule properties
// callback - f(err, schedule)
WorkflowBackend.prototype.getSchedule = function (uuid, meta, callback) {
    throw new Error('Backend.getSchedule is not implemented');
};

// Get all the schedules:
// callback - f(err, schedules)
WorkflowBackend.prototype.getSchedules = function (callback) {
    throw new Error('Backend.getSchedules is not implemented');
};

// Run or finalize pending schedule jobs
// callback - f(err)
WorkflowBackend.prototype.runSchedules = function (callback) {
    throw new Error('Backend.runSchedules is not implemented');
};

// Find next schedules to queue
// callback - f(err, schedules)
WorkflowBackend.prototype.nextSchedules = function (callback) {
    throw new Error('Backend.nextSchedules is not implemented');
};

// schedule - the schedule object
// meta - Any additional information to pass to the backend which is not
//        schedule properties
// callback - f(err, scheduleJob)
WorkflowBackend.prototype.createScheduleJob = function (schedule, callback) {
    throw new Error('Backend.createScheduleJob is not implemented');
};

// uuid - ScheduleJob.uuid
// meta - Any additional information to pass to the backend which is not
//        schedule job properties
// callback - f(err, schedule)
WorkflowBackend.prototype.getScheduleJob = function (uuid, callback) {
    throw new Error('Backend.getScheduleJob is not implemented');
};

// Get all the schedule jobs:
// schedule - the schedule object
// callback - f(err, scheduleJobs)
WorkflowBackend.prototype.getScheduleJobs = function (schedule, callback) {
    throw new Error('Backend.getScheduleJobs is not implemented');
};

// scheduleJob - the schedule job object
// meta - Any additional information to pass to the backend which is not
//        schedule job properties
// callback - f(err, boolean)
WorkflowBackend.prototype.deleteScheduleJob = function (scheduleJob, callback) {
    throw new Error('Backend.deleteScheduleJob is not implemented');
};

// Get a single schedule job property
// uuid - Schedule job uuid.
// prop - (String) property name
// cb - callback f(err, value)
WorkflowBackend.prototype.getScheduleJobProperty = function (uuid, prop, cb) {
    throw new Error('Backend.getScheduleJobProperty is not implemented');
};

// Update only the given Schedule job property. Intendeed to prevent conflicts
// withtwo sources updating the same job at the same time, but different
// properties
//
// uuid - the schedule job's uuid
// prop - the name of the property to update
// val - value to assign to such property
// meta - Any additional information to pass to the backend which is not
//        job properties
// callback - f(err) called with error if something fails, otherwise with null.
WorkflowBackend.prototype.updateScheduleJobProperty = function (
    uuid,
    prop,
    val,
    meta,
    callback)
{
    throw new Error('Backend.updateScheduleJobProperty is not implemented');
};

// schedule - the schedule object
// callback - f(err) called with error in case there is a duplicated
// schedule with the same target and same params
WorkflowBackend.prototype.validateSchedule = function (schedule, callback) {
    throw new Error('Backend.validateScheduleTarget is not implemented');
};