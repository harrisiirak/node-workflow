...
WorkflowBackend.prototype.getSchedule = function (schedule, meta, callback) {
...
WorkflowBackend.prototype.updateScheduleJob = function (scheduleJob, callback) {
    throw new Error('Backend.updateScheduleJob is not implemented');
};

WorkflowBackend.prototype.runScheduleJob = function (scheduleJob, callback) {
    throw new Error('Backend.runScheduleJob is not implemented');
};

WorkflowBackend.prototype.validateScheduleTarget = function (schedule, callback) {
